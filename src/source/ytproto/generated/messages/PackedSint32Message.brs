' Auto-generated encoder/decoder for samples.PackedSint32Message

function PackedSint32MessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            ...
            __pb_writeVarint64(valuesPacked, encoded)
        end for
...
function PackedSint32MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 0 then
                ...
                valuesValues.Push(__pb_decodeZigZag32(valueResult.value))
