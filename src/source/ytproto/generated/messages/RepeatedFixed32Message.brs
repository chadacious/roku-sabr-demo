' Auto-generated encoder/decoder for samples.RepeatedFixed32Message

function RepeatedFixed32MessageEncode(message as Object) as String
...
function RepeatedFixed32MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 5 then
                ...
                valuesValues.Push(__pb_toUnsigned32(fixedResult.value))
