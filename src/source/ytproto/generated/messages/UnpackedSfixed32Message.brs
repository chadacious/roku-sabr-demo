' Auto-generated encoder/decoder for samples.UnpackedSfixed32Message

function UnpackedSfixed32MessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        for each valuesItem in valuesItems
            ...
            __pb_writeFixed32(bytes, valuesItem)
        end for
...
function UnpackedSfixed32MessageDecode(encoded as String) as Object
