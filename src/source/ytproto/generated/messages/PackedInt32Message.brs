' Auto-generated encoder/decoder for samples.PackedInt32Message

function PackedInt32MessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            normalized = __pb_normalizeSigned32(valuesItem)
            __pb_writeVarint(valuesPacked, normalized)
        end for
...
function PackedInt32MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 0 then
                ...
                valuesValues.Push(__pb_toSigned32FromString(valueResult.value))
