' Auto-generated encoder/decoder for samples.PackedSint64Message

function PackedSint64MessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            encoded = __pb_encodeZigZag64(valuesItem)
...
function PackedSint64MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 0 then
                ...
                valuesValues.Push(__pb_decodeZigZag64(valueResult.value))
