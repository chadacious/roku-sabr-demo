' Auto-generated encoder/decoder for samples.RepeatedFixed64Message

function RepeatedFixed64MessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            __pb_writeFixed64(valuesPacked, valuesItem)
        end for
...
function RepeatedFixed64MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 1 then
                ...
                valuesValues.Push(fixedResult.value)
