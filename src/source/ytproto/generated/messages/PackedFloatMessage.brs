' Auto-generated encoder/decoder for samples.PackedFloatMessage

function PackedFloatMessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            ...
            __pb_writeFloat32(valuesPacked, normalized)
        end for
...
function PackedFloatMessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 5 then
                ...
                valuesValues.Push(floatResult.value)
