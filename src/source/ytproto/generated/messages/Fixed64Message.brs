' Auto-generated encoder/decoder for samples.Fixed64Message

function Fixed64MessageEncode(message as Object) as String
    ...
    if field_value <> invalid then
        if not __pb_scalarEqualsDefault(field_value, "fixed64", "0") then
...
function Fixed64MessageDecode(encoded as String) as Object
