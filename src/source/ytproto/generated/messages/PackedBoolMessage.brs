' Auto-generated encoder/decoder for samples.PackedBoolMessage

function PackedBoolMessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            boolValue = valuesItem
            valueType = Type(boolValue)
            ...
            __pb_writeVarint(valuesPacked, boolInt)
        end for
...
function PackedBoolMessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 0 then
                ...
                valuesValues.Push(valueResult.value <> 0)
