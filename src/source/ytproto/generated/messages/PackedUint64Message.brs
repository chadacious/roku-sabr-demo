' Auto-generated encoder/decoder for samples.PackedUint64Message

function PackedUint64MessageEncode(message as Object) as String
...
function PackedUint64MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 0 then
                ...
                valuesValues.Push(valueResult.value)
