' Auto-generated encoder/decoder for samples.RepeatedSfixed32Message

function RepeatedSfixed32MessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            __pb_writeFixed32(valuesPacked, valuesItem)
        end for
...
function RepeatedSfixed32MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 5 then
                ...
                valuesValues.Push(__pb_toSigned32(fixedResult.value))
