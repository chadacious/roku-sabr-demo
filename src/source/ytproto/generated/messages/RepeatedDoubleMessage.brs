' Auto-generated encoder/decoder for samples.RepeatedDoubleMessage

function RepeatedDoubleMessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            ...
            __pb_writeFloat64(valuesPacked, normalized)
        end for
...
function RepeatedDoubleMessageDecode(encoded as String) as Object
