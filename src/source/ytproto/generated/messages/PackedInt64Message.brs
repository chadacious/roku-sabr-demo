' Auto-generated encoder/decoder for samples.PackedInt64Message

function PackedInt64MessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        ...
        for each valuesItem in valuesItems
            __pb_writeVarint64(valuesPacked, valuesItem)
        end for
...
function PackedInt64MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            ...
            if wireType = 0 then
                ...
                valuesValues.Push(__pb_toSignedInt64String(valueResult.value))
