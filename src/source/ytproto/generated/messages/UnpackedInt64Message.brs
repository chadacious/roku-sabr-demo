' Auto-generated encoder/decoder for samples.UnpackedInt64Message

function UnpackedInt64MessageEncode(message as Object) as String
    ...
    if valuesItems <> invalid then
        for each valuesItem in valuesItems
            ...
            __pb_writeVarint64(bytes, valuesItem)
        end for
...
function UnpackedInt64MessageDecode(encoded as String) as Object
