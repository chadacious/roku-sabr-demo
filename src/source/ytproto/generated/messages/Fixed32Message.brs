' Auto-generated encoder/decoder for samples.Fixed32Message

function Fixed32MessageEncode(message as Object) as String
    ...
    if field_value <> invalid then
        if not __pb_scalarEqualsDefault(field_value, "fixed32", "0") then
...
function Fixed32MessageDecode(encoded as String) as Object
    ...
    while cursor < limit
        ...
        if fieldNumber = 1 then
            if wireType = 5 then
                ...
                valueValue = __pb_toUnsigned32(fixedResult.value)
